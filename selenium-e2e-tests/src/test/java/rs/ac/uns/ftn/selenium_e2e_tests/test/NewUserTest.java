...
import rs.ac.uns.ftn.selenium_e2e_tests.pages.NewUserPage;
...
public class NewUserTest {
	...
	public void usernamePasswordLoginTest() throws InterruptedException{
		...
		usernamePasswordLoginPage.writeUserNameInput("admin@gmail.com");
		usernamePasswordLoginPage.writePasswordInput("admin");
