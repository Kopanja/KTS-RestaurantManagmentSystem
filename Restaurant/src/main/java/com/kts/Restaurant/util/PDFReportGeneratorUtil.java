...
public class PDFReportGeneratorUtil {
	...
	public static PdfPTable createTable(Document document, int noOfColumns, List<String> columnNames) throws DocumentException {
